...
The website consists of three pages, each having a specific purpose and all formatted intuitively.

* Navigation and Footer

The navigation is repeated through the site for consistency and responsive design is implemented for smaller screens. 
...
The About Us page introduces more information to the user, photos of the teachers are structured in a way to be casual, responsive design allows specific photos to be shown on smaller screens. The class timetable is simple and clear in its function.
...
![wireframes](/assets/images/wirefames.png)
...
* Images used throughout the site follow the important elements of the site design, and focus on simplicity and consistency.
...
### Content
* [Rytr](https://rytr.me/) Testimonial content generator
* [Techsini](http://techsini.com) Mockup of responsive displays for README.md
